const WowDragons = () => {
  return (
      ...
      <div>
        <h1 className="pageHeader"><text>Dragons of Azeroth (WoW)</text></h1>
        <p>In world of Warcraft, Dragons started out as normal, intelligent, typically good creatures. 
          ...
          now known) was defeated (but not destroyed quite yet).</p>
        <br /><br />
        <div id="Alexstrasza" className="wowDragonTab">
          <h1 className="wowDragonHeader">Alexstrasza and The Red Dragonflight</h1>
          <p>Before leaving Azeroth, the Titan Eonar (patron of life) gave some of her power to the compassionate (yet fierce)
          ...
          <br />
          <img className="aspectImage" src="Alexstrasza.jpg" title="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.pinterest.com%2Fgzhwiner%2Falexstrasza%2F&psig=AOvVaw3miAmpIcsgLT7Pr-E7NmKc&ust=1663805876185000&source=images&cd=vfe&ved=0CAwQjRxqFwoTCNjf4IXOpPoCFQAAAAAdAAAAABAD" />
        </div>
        <div id="Ysera" className="wowDragonTab">
          <h1 className="wowDragonHeader">Ysera and The Green Dragonflight</h1>
          <p> After giving Alexstrasza a great portion of her power, the Titan Eonar bestowed power to Ysera as well. To Ysera, she gave
          ...
          <br />
          <img className="aspectImage" src="Ysera.webp" title="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwowpedia.fandom.com%2Fwiki%2FYsera&psig=AOvVaw28_qi5QfcTj7BQNCQLrOdH&ust=1663806169871000&source=images&cd=vfe&ved=0CAwQjRxqFwoTCODKypDPpPoCFQAAAAAdAAAAABAD" />
        </div>
        <div id="Malygos" className="wowDragonTab">
          <h1 className="wowDragonHeader">Malygos and The Blue Dragonflight</h1>
          <p> The Titan Norgannon (the titan master-magician and lore-keeper) gave Malygos a huge portion of his magic weilding power. 
          ...
          <br />
          <img className="aspectImage" src="malygos.webp" title="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwowpedia.fandom.com%2Fwiki%2FMalygos&psig=AOvVaw2R_InYSL2y1kovCBooHJj-&ust=1663806265855000&source=images&cd=vfe&ved=0CAwQjRxqFwoTCPjbgsHPpPoCFQAAAAAdAAAAABAD" />
        </div>
        <div id="Nozdormu" className="wowDragonTab">
          <h1 className="wowDragonHeader">Nozdormu and The Bronze Dragonflight</h1>
          <p> The Titan Aman'Thul, the oldest and wisest Titan, bestowed his power over time on Nozdormu and turned Nozdormu into the keeper of time and 
            ...
            with his flight and rarely made appearances, even to help the other flights. Because of this, not much is really known about the bronze dragonflight.
            However, what little the residents of Azeroth know is that they are good and continue to safeguard the flow of time for the good of Azeroth and all 
            life.
            <br />
            During the great cataclysm caused by Deathwing, the bronze dragonflight was forced to be a much more present flight. Members of their flight from the future, led 
            by a misintentioned Nozdormu from the future, try to destroy Azeroth in a misguided attempt to save the universe (a path that present-day Nozdormu can see will 
            be the real cause of the universe's destruction). The present-day bronze dragonflight continues to win battles against the "Infinite dragonflight" (as the evil 
            bronze dragons from the future call themselves), but Nozdormu is burdened with the sadness that one day his flight will cause much death and sadness to the 
            people he strives to protect.
          </p>
          <br />
          <img className="aspectImage" src="Nozdormu.webp" title="https://static.wikia.nocookie.net/wowpedia/images/7/76/Nozdormu_the_Timeless.jpg/revision/latest/scale-to-width-down/1000?cb=20191104202353" />
        </div>
        <div id="Neltharion" className="wowDragonTab">
          <h1 className="wowDragonHeader">Neltharion and The Black Dragonflight</h1>
          <p> The Titan Khaz'Goroth imbued Neltharion with his power of shaping and molding the world. Neltharion and his black dragonflight embodied strength and 
            loyalty for millenia. Through his benevolence and grace, Neltharion gained the title of "The Earthwarder" as he shaped Azeroth for the benefit of the mortals 
            who lived on it. 
            <br />
            Slowly, but surely, the Old Gods crept into Neltharion's mind as he spent more and more time in the earth of Azeroth (and therefor closer to their prisons). 
            During the War of the Ancients, Neltharion's mind was completely corrupted. He chose that war to betray his former friends, almost destroyed them and the other denizens 
            of Azeroth, and he and his flight spend the rest of their lives trying to carry out the will of the Old Gods and destroy all life on Azeroth. Neltharion's children 
            are instrumental in the creation of many abominable dragon races and monsters, as well as the toppling of kingdoms and the orchestration of wars.
          </p>
          <br />
          <img className="aspectImage" src="Neltharion-Good.webp" title="https://static.wikia.nocookie.net/wowpedia/images/a/a8/Neltharion_TCG.jpg/revision/latest/scale-to-width-down/180?cb=20120916044825" />
        </div>
      </div>
