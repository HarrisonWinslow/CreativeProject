const Home = () => {
  return (
      ...
      <div>
        <div className="row">
          <div className="col-xs-12 col-sm-6 col-md-8 col-centered">
            <div className="maintxt">
              <img alt="landscape" src="fantasy-landscape.png" className="img-responsive" />
              <span className="overlay-text hide-mobile" style={{width: '100vw'}}>
                <br /><br /><br /><br />
        ...
        <div className="flexBox normal-div">
          <div className="imageFlexBox normal-div">
            <div className="imgTitle normal-div">
              <strong>Blizzard's World of Warcraft (WoW) </strong><br />
              <a href="/blogs">
          ...
          <div className="imageFlexBox normal-div">
            <div className="imgTitle normal-div">
              <strong>Wizards of the Coast's Forgotten Realms (DnD) </strong><br />
              <a href="/blogs">
          ...
          <div className="imageFlexBox normal-div">
            <div className="imgTitle normal-div">
              <strong>Riot's League of Legends (Runeterra) </strong><br />
              <a href="/blogs">
